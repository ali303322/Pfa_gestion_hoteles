...
<html lang="en">
  ...
  <body>
    <nav>
      ...
      <ul class="nav__links">
        <li class="link"><a href="#"><img src="assets/home.png" alt="" style="width: 20px ; height : 20px ; margin:auto">Home</a></li>
        <li class="link"><a href="#"><img  src="assets/call-center.png" alt="" style="width: 25px ; height : 25px ; margin:auto">Assistance</a></li>
       <li class="link"><a href="#"><img src="assets/telephone.png" alt="" style="width: 25px ; height : 25px ; margin:auto">Contact Us</a></li>
       <li class="link"><a href="#"><img  src="assets/enter.png" alt="" style="width: 25px ; height : 25px ; margin:auto">Login</a></a></li>
      </ul>
    </nav>
    ...
    <section class="section__container popular__container">
      ...
      <div class="popular__grid">
        <div class="popular__card">
          <img src="assets/Essaouira.jpg" alt="popular hotel" />
          <div class="popular__content">
            <div class="popular__card__header">
              <h4>Essaouira Hotel</h4>
              <h4>$300</h4>
            </div>
